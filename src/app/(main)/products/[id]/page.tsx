                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-y-16 md:gap-x-[71px] max-w-4/5 mx-auto pb-[4.6875rem]'>
                    ...
                    <div>
                        <div className='flex justify-between items-center'>
                            <h3 className='text-[1.625rem] font-bold'>Product Name</h3>
                            <HeartIcon size={20} />
                        </div>
                        <div className='flex items-center gap-2.5 my-3'>
                            <span className='text-3xl border-r-2 border-accent-foreground pr-2.5'>123 EGP</span>
                        ...
                        <hr className='my-5' />
                        <div>
                            <p>Lorem ipsum dolor sit amet, consectetuer adipi scing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magn. Lorem ipsum dolor sit amet, consectetuer adipi scing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magn.</p>
                            <ul className='list-disc mt-8 list-inside'>
